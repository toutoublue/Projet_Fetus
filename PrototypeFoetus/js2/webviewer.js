...
/*
 ...
 handleLoadedTeapot(JSON.parse(request.responseText),mesh);
 loading.textContent = "";
 loading.style.backgroundColor = "#fff";
 }
 }
 loading.textContent = "Loading Teapot...";
...
function init_stats()
{
	...
	var viewer_ = document.getElementById("viewer");
    viewer_.appendChild(stats.domElement);
...
function setupCanvasMousing(c)
{
    ...
    document.mouseMoveHandler = function(event)
    {
        ...
        {
            var mouse_pos = document.getAbsolutePosition(this.hover_object);
...
function handleFiles(files)
{
    ...
    if (file)
    {
        ...
        {
            setTimeout(function() {
                readOFF_from_string(evt.target.result, mesh);
                setTimeout(function() {
                    handleLoadedMesh(mesh);
                    loading.textContent = "";
                }, 0);
                loading.textContent = "Handling OFF...";
                loading.style.backgroundColor = "#fab";
            }, 0);
            loading.textContent = "Loading OFF...";
            loading.style.backgroundColor = "#5f4";
        }
...
/*unction init_drag_and_drop(canvas)
{
...
*/
/*
function smooth_form_submit()
{
    mesh_request("./process.php", mesh, "smooth", update_vertices);
    return false;
}
*/
function webGLStart(canvas_id, error_id) {
    ...
    setTimeout(function() {
        ...
        loading.style.backgroundColor = "#5f4";
        //readOBJ_from_server("elephant.obj",mesh, function(mesh)
        
         readOBJ_from_server("cow.obj",mesh, function(mesh)
         {
